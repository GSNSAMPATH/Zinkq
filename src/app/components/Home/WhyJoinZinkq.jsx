...
export default function WhyJoinZinkq() {
  return (
    <section className="pb-20 mx-2 md:mx-4 lg:mx-8  rounded-b-3xl py-8">
      <div className="md:px-10 xl:px-12 2xl:px-20 mx-auto px-2 py-12 rounded-xl md:rounded-3xl bg-[#F0F2F4] grid lg:grid-cols-2 gap-10 items-center">
        
        {/* LEFT CONTENT */}
        <div className="order-2 lg:order-1">
          <h2 className="font-roboto text-[20px] md:text-[38px] lg:text-[48px] font-bold mb-4">Why Join Zinkq</h2>

          <p className="font-roboto text-[14px] md:text-[16px] lg:text-[20px] text-gray-700 mb-1">Because no one builds alone.</p>
          <p className=" font-roboto text-[14px] md:text-[16px] lg:text-[20px] text-gray-700 mb-6">
          ...
          <p className="mt-6 text-gray-700 font-roboto text-[14px] md:text-[16px] lg:text-[20px]">
